...
<head>
    ...
    <title>Land Record System || Manage Land/Property </title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Property </h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Manage Land/Property </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                  ...
                  <th>Land/Property Subtype</th>
                   <th>Action</th>
                                        ...
                                        <tbody>
                                           <?php
$ret=mysqli_query($con,"select tblproperty.*,tblpropertytype.PropertType from tblproperty join tblpropertytype on tblpropertytype.ID=tblproperty.PropertyID");
$cnt=1;
...
?>
                ...
                <tr>
                  ...
                  <td>
<a href="property-details.php?editid=<?php echo $row['ID'];?>" class="btn btn-info" target="blank">View</a>
