...
$extension = substr($switphoto,strlen($switphoto)-4,strlen($switphoto));
...
$secwitpic=md5($switphoto).time().$extension;
move_uploaded_file($_FILES["switphoto"]["tmp_name"],"secwitnessimages/".$secwitpic);
   

    $query=mysqli_query($con,"update tblproperty set secwitpic='$secwitpic' where ID='$cid'");
...
?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Old Second Witness Image</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              
                                           <img src="secwitnessimages/<?php echo $row['secwitpic'];?>" width="200" height="150" value="<?php  echo $row['secwitpic'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
