...
$extension = substr($landfirstphoto,strlen($landfirstphoto)-4,strlen($landfirstphoto));
...
$landfirstpic=md5($landfirstphoto).time().$extension;

   move_uploaded_file($_FILES["landfirstphoto"]["tmp_name"],"landfimages/".$landfirstpic);
   

    $query=mysqli_query($con,"update tblproperty set landfirstpic='$landfirstpic' where ID='$cid'");
...
?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Old Land First Image</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              
                                           <img src="landfimages/<?php echo $row['landfirstpic'];?>" width="200" height="150" value="<?php  echo $row['landfirstpic'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
