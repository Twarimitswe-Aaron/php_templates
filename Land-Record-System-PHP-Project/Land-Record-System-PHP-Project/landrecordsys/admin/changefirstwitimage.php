...
$extension = substr($fwitphoto,strlen($fwitphoto)-4,strlen($fwitphoto));
...
$fwitpic=md5($fwitphoto).time().$extension;
move_uploaded_file($_FILES["fwitphoto"]["tmp_name"],"firstwitnessimages/".$fwitpic);
   

    $query=mysqli_query($con,"update tblproperty set fwitpic='$fwitpic' where ID='$cid'");
...
?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Old First Witness Image</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              
                                           <img src="firstwitnessimages/<?php echo $row['fwitpic'];?>" width="200" height="150" value="<?php  echo $row['fwitpic'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
