...
//fetured Image
$secpartypic=$_FILES["secpartypic"]["name"];
$extension = substr($secpartypic,strlen($secpartypic)-4,strlen($secpartypic));
...
$spartypic=md5($secpartypic).time().$extension;

   move_uploaded_file($_FILES["secpartypic"]["tmp_name"],"secpartypic/".$spartypic);
   

    $query=mysqli_query($con,"update tblproperty set secpartypic='$spartypic' where ID='$cid'");
...
?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Old Image(Second Party Image)</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              
                                            <img src="secpartypic/<?php echo $row['secpartypic'];?>" width="200" height="150">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">New Photo</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="file" name="secpartypic" id="secpartypic" required="true" class="form-control">
                                            </div>
                                        </div>
                                        <?php } ?>
