...
$extension = substr($landmap,strlen($landmap)-4,strlen($landmap));
...
$landmappic=md5($landmap).time().$extension;

   move_uploaded_file($_FILES["landmap"]["tmp_name"],"landmapimages/".$landmappic);
   

    $query=mysqli_query($con,"update tblproperty set landmappic='$landmappic' where ID='$cid'");
...
?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Old Land Map Image</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              
                                           <img src="landmapimages/<?php echo $row['landmappic'];?>" width="200" height="150" value="<?php  echo $row['landmappic'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
