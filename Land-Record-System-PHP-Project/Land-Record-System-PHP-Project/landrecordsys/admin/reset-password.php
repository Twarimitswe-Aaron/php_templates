...
<head>
    ...
    <title>Land Record System || Reset Page</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><h2 style="color: blue">Land Record System</h2><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
