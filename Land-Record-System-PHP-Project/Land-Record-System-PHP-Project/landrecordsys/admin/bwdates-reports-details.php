...
<head>
    ...
    <title>Land Record System || B/W date Reports</title>
    <!-- Bootstrap CSS -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tr>
                  <th>S.NO</th>
                  <th>Land/Properties Number</th>
                  <th>Land/Properties Type</th>
                  <th>Land Subtype</th>
                   <th>Action</th>
                </tr>
                                        </thead>
...
<?php
$ret=mysqli_query($con,"select tblproperty.*,tblpropertytype.PropertType from tblproperty join tblpropertytype on tblpropertytype.ID=tblproperty.PropertyID  where date(tblproperty.CreationDate) between '$fdate' and '$tdate'");
$cnt=1;
