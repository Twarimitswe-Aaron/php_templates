 <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="dashboard.php">Land Record System</a>
...
?>
                                ...
                                <a class="dropdown-item" href="change-password.php"><i class="fas fa-cog mr-2"></i>Change Password</a>
